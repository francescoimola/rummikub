...
image: /assets/writing/Write_a_welcome_email_f3lztn.png
alt: "Welcome emails: why bother? (and how to write them)"
type: guides
...
And as sure as eggs is eggs, **they get far better engagement than regular emails**. According to [Invesp](https://www.invespcro.com/blog/welcome-emails/), welcome emails have an average of 4x more opens and 5x more clicks than standard email campaigns. There really is no excuse not to send one.
...
### 1. A subject line that isn't simply _Welcome!_
...
Some skip this step but (depending on the audience) it can work wonders. Justin Jackson, co-founder of Transistor.fm, asks a question both in the subject line AND the email body. He [sends new users a welcome email](https://justinjackson.ca/welcome-email) with this subject:

_What brought you here?_

The email itself is short. It introduces Justin, explains what Transistor does, and then asks:

_What's happening in your world that brought you to Transistor?_
...
_What made you sign up today?_
Better.

_What's the biggest challenge you're dealing with right now?_
Works if that's actually relevant to what you're selling.

_What's happening in your world that brought you to us?_
If you want to copy Transistor nobody's stopping you.
...
- There's real complexity to the onboarding process (software, courses, memberships)
- You're guiding people through a transformation that takes time
- You have a number of offers that _you know_ readers will find valuable, and you want to spread them over X many weeks.
...
[As Jimmy Kim observed](https://x.com/yojimmykim/status/1902843002365591730), brands waste this moment by going straight to sending welcome sequences... and then they read like this:

- Email 1: Welcome to our brand!
- Email 2: Here's our story
- Email 3: Check out our products
