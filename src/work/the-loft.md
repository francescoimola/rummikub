...
The initial user research I conducted showed two main problems: we were dealing with ambiguous messaging and a gap between the user understanding the offerings and taking action.

Messaging-wise, the site was failing to address visitors' pain points and offer clear solutions. Pages were thin where they needed depth, or front-loaded with disclaimers in places that should have been quick to move past.

The aforementioned gap showed up as a conversion barrier at the narrowest part of the funnel: even if visitors found their way to the 'correct' part of the site, they'd be dropped straight into the booking process before they knew what they were booking.

{% figureImg "/assets/portfolio/theloft-sublime.png", "Canvas with early design references scattered throughout", caption="Early brainstorming session covering history and design direction" %}

{% figureImg "/assets/portfolio/theloft-wireframes.png", "Figma screen with an overview of desktop wireframes for The Loft's website", caption="Developing the wireframes on Figma" %}

## Approach

I developed a [StoryBrand](https://www.impactplus.com/learn/what-is-the-storybrand-framework) redesign that flipped the job of the website from mostly transactional to mostly nurturing, with the visitor as the hero of their story and the brand as the guide that offers them a clear path to follow.
...
What he took ownership of was a new visual identity with a versatile redesign of their original wordmark and a four-page website, cut down from fourteen, that looks more youthful and makes a stronger case for The Loft.
...
Visit [theloftstudio.uk](https://www.theloftstudio.uk/) to learn more about The Loft.
