...
{% projectVideo "/assets/portfolio/theloft-events.mp4", "Events page walkthrough", caption="Events page design" %}
...
{% projectVideo "/assets/portfolio/theloft-logo-images.mp4", "Logo over a series of images", caption="The Loft's new logo is a minimal workmark that references their original logotype" %}
