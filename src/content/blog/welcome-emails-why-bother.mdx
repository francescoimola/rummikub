...
excerpt: "What to write in a welcome email that people want to read. Including examples, 5 content must-haves, and how to get replies from new subscribers."
coverImage: "../../assets/blog/Write_a_welcome_email_f3lztn.png"
tags: ["Emails"]
slug: "welcome-emails-why-bother"
---
...
This is your chance to offer a 10% discount to get customers in the door. And, even better, it's also an opportunity to connect with your subscribers and **become the familiar face in a sea of indistinguishable brands**.
...
![Example of a good subject line](../../assets/blog/subjectline.png)
...
![Example of a reminder section in a welcome email](../../assets/blog/emailreminder.png)
...
![Example of setting expectations in a welcome email](../../assets/blog/useful-offer.png)
...
![Example of providing immediate value in a welcome email](../../assets/blog/what-they-are-getting.png)

### 5. Offer an easy way out

Make it simple to unsubscribe. It keeps your list healthy and stops people resenting you.

![Example of an unsubscribe option in a welcome email](../../assets/blog/way-out.png)

## Want replies? Do this

Ask them a question.

Some skip this step but (depending on the audience) it can work wonders.

Justin Jackson, co-founder of Transistor.fm, asks a question both in the subject line AND the email body. He [sends new users a welcome email](https://justinjackson.ca/welcome-email) with this subject:
...
He reports getting dozens of replies every week. And, I can assume, is not because he's being manipulative, but because he's asking from a genuine place and people can tell the difference.

The trick, if there's one, is making your question specific and easy to answer:
...
[![Screenshot of Really Good Emails welcome email collection](../../assets/blog/reallygoodemails.png)](https://reallygoodemails.com/categories/welcome)
