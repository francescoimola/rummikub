...
coverImage: ../../assets/portfolio/makemind_homepage.png
results:
...
import makemindVideo from '../../assets/portfolio/makemind_animated.mp4';

<ProjectVideo src={makemindVideo} alt="Showcase of the Make & Mind website homepage" caption="Homepage overview" />
