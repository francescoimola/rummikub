...
import { l as getDefaultExportFromCjs, q as renderJSX, v as createVNode, w as AstroJSX, x as AstroUserError } from './astro/server_DjWKGrLa.mjs';
...
async function check$1(Component, props, children) {
  ...
  if (Component.prototype != null && typeof Component.prototype.render === "function") {
    return o.Component.isPrototypeOf(Component) || o.PureComponent.isPrototypeOf(Component);
  }
...
async function renderToStaticMarkup$1(Component, props, { default: children, ...slotted }, metadata) {
  ...
  for (const [key, value] of Object.entries(slotted)) {
    ...
    slots[name] = o.createElement(static_html_default, {
  ...
  if (newChildren != null) {
    newProps.children = o.createElement(static_html_default, {
      hydrate: needsHydration(metadata),
      value: newChildren
    });
  }
  ...
  const vnode = o.createElement(Component, newProps);
  const renderOptions = {
...
const renderers = [Object.assign({"name":"@astrojs/react","clientEntrypoint":"@astrojs/react/client.js","serverEntrypoint":"@astrojs/react/server.js"}, { ssr: server_default$1 }),Object.assign({"name":"astro:jsx","serverEntrypoint":"file:///Users/francescoimola/Repositories/rummikub/node_modules/.pnpm/@astrojs+mdx@4.3.13_astro@5.16.11_rollup@4.55.1_typescript@5.9.3_yaml@2.8.2_/node_modules/@astrojs/mdx/dist/server.js"}, { ssr: server_default }),];

export { React as R, renderers as a, requireReactDom as b, o, reactExports as r };
